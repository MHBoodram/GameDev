class_name DialogueManagerMainBalloon extends CanvasLayer
...
func main_tween_bounce() -> void:
	var tween = get_tree().create_tween()
	var old_position = 0
	print($Balloon/MarginContainer.position.y)
	tween.set_trans(Tween.TRANS_SINE)
	tween.set_ease(Tween.EASE_OUT)
	tween.tween_property($Balloon/MarginContainer,"position:y",old_position+10,1)
	tween.tween_property($Balloon/MarginContainer,"position:y",old_position,1)
